    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShopongCarts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ShopongCarts_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ShopongCarts_Products_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShopongCarts_ApplicationUserId",
                table: "ShopongCarts",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_ShopongCarts_ProductId",
                table: "ShopongCarts",
                column: "ProductId");
        }
